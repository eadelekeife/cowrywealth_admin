...
const NewEvent = () => {
    ...
    const saveNewEvent = e => {
        ...
        let startTime = String(startTime).split(currYear)[1].split('GMT')[0].split(' ')[1];
        let endTime = String(endTime).split(currYear)[1].split('GMT')[0].split(' ')[1];

        axios.post('/uploadevent', {
            imageUrl, mainImageUrl, eventTitle, eventOrganizer, eventCategory, eventType, eventState: eventStateValue, eventLGA,
                                                                            ...
                                                                            <div className="form-group">
                                                                                ...
                                                                                <Controller control={control} defaultValue="" name="eventState"
                                                                                    render={({ field }) => (
                                                                                        ...
                                                                                        //     type="text" style={{ height: '3rem' }} />
                                                                                        <Select
                                                                                            onChange={handleStateChange} id="state"
