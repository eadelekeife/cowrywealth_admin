...
const AllEvents = () => {
    ...
    useEffect(() => {
        axios('/admin/get_all_administrators')
            .then(eventsData => {
    ...
    const data = ambassadorsData.map((ambassador, index) => {
        return {
            ...
            eventsAdded: ambassador.Ambassador.EventsRecords.length,
            communitiesAdded: ambassador.Ambassador.CommunityRecords.length,
            businessesAdded: ambassador.Ambassador.BusinessRecords.length,
